...
{
    public partial class BookBagForm : Form
    {
...
INNER JOIN BookCategories C ON B.CategoryId = C.CategoryId";
            ...
            int price = pricelabel.TabIndex;

        }
        private void dataGridViewBag_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            int rowIndx = e.RowIndex;
